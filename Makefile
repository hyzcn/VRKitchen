...
VRInteractPlatform-Linux-Debug:
	 $(PROJECTBUILD) VRInteractPlatform Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatform-Linux-DebugGame:
	 $(PROJECTBUILD) VRInteractPlatform Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatform-Linux-Shipping:
	 $(PROJECTBUILD) VRInteractPlatform Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatform-Linux-Test:
	 $(PROJECTBUILD) VRInteractPlatform Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatform:
	 $(PROJECTBUILD) VRInteractPlatform Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatformEditor-Linux-Debug:
	 $(PROJECTBUILD) VRInteractPlatformEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatformEditor-Linux-DebugGame:
	 $(PROJECTBUILD) VRInteractPlatformEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatformEditor-Linux-Shipping:
	 $(PROJECTBUILD) VRInteractPlatformEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatformEditor-Linux-Test:
	 $(PROJECTBUILD) VRInteractPlatformEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRInteractPlatformEditor:
	 $(PROJECTBUILD) VRInteractPlatformEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
