...
unrealRootPath=/home/binroot/UnrealEngine-4.13
VRInteractPlatformRootPath=/home/binroot/vcla_vrinteract-master

gameProjectFile=/home/binroot/vcla_vrinteract-master/VRInteractPlatform.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(VRInteractPlatformSource.pri)
include(VRInteractPlatformHeader.pri)
include(VRInteractPlatformConfig.pri)
include(VRInteractPlatformIncludes.pri)
include(VRInteractPlatformDefines.pri)
...
VRInteractPlatform-Linux-Debug.commands = $$build VRInteractPlatform Linux Debug  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatform-Linux-DebugGame.commands = $$build VRInteractPlatform Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatform-Linux-Shipping.commands = $$build VRInteractPlatform Linux Shipping  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatform-Linux-Test.commands = $$build VRInteractPlatform Linux Test  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatform.commands = $$build VRInteractPlatform Linux Development  -project="\"$$gameProjectFile\"" $$args

VRInteractPlatformEditor-Linux-Debug.commands = $$build VRInteractPlatformEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatformEditor-Linux-DebugGame.commands = $$build VRInteractPlatformEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatformEditor-Linux-Shipping.commands = $$build VRInteractPlatformEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatformEditor-Linux-Test.commands = $$build VRInteractPlatformEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
VRInteractPlatformEditor.commands = $$build VRInteractPlatformEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	VRInteractPlatform-Linux-Debug \
	VRInteractPlatform-Linux-DebugGame \
	VRInteractPlatform-Linux-Shipping \
	VRInteractPlatform-Linux-Test \
	VRInteractPlatform \
	VRInteractPlatformEditor-Linux-Debug \
	VRInteractPlatformEditor-Linux-DebugGame \
	VRInteractPlatformEditor-Linux-Shipping \
	VRInteractPlatformEditor-Linux-Test \
	VRInteractPlatformEditor \
